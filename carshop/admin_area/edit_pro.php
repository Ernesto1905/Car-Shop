...
<form method="post" action="" enctype="multipart/form-data">
    ...
    <table width="794" align="center" border="1" bgcolor="#3399CC" >
        ...
        <td colspan="2"><h1>Ürün Güncelle:</h1></td>
        
        </tr>
        
        <tr>
        	<td align="right"><b>Ürün Adı</b></td>
    	 ...
    	 <tr>
         	<td align="right"><b>Ürün Anahtar Kelimeler</b></td>
        	<td><input type="text" name="product_keywords" size="50" value="<?php echo $p_keywords; ?>"/></td>
        </tr>
    
     <tr align="center">
        	<td colspan="2"><input type="submit" name="update_product" value="Güncelle"/></td>
        </tr>
...
<?php 
	...
	if(isset($_POST['update_product'])){
		...
		if($product_title=='' OR $product_cat=='' OR $product_brand=='' OR $product_price=='' OR $product_desc=='' OR $product_keywords=='' OR $product_img1==''){
			...
			echo "<script>alert('Tüm alanları doldur!')</script>";
			exit();
			}
