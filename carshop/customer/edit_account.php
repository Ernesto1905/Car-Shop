...
?>
 <form action="" method="post" enctype="multipart/form-data">
                ...
                <table align="center" width="600">
                    ...
                    <tr>
                    	<td colspan="8" align="center"><h2>Hesabını Güncelle:</h2></td>
                    </tr>
              
              		<tr>
                    	<td align="right">Müşteri Ad:</td>
                    ...
                    <tr>
                    	<td align="right">Müşteri Şifre:</td>
                        <td><input type="password" name="c_pass" value="<?php echo $pass; ?>"></td>
                    </tr>
                    
                    <tr>
                    	<td align="right">Müşteri Ülke:</td>
                        <td>
                        <select name="c_country" enabled>
...
<?php 
	...
	if(isset($_POST['update_account'])){
		...
		if($run_c){
			...
			echo "<script>alert('Hesabın güncellendi!')</script>";
