			...
			if(!isset($_GET['edit_account'])){
				if(!isset($_GET['change_pass'])){
					...
					if($count_orders>0){
						...
						<h1 style='color:red; text-decoration:underline;'>Önemli!</h1>
						<h2> ($count_orders) işlem bekleyen siparişiniz var.</h2>
						<h3>Sipariş detaylarını görmek için linke tıkla <a href='my_account.php?my_orders'>Link</a><br> Veya <a href='pay_offline.php' target='_blank'>Çevrimdışı Öde</a></h3>
						...
						<div style='padding:10px;'>
						<h1 style='color:red; text-decoration:underline;'>Önemli!</h1>
						<h2>Bekleyen siparişiniz yok!</h2>
						<h3>Sipariş geçmişinizi, burayı tıklatarak görebilirsiniz. <a href='my_account.php?my_orders'>Link</a></h3>
